...
urlpatterns = [
    ...
    path("plateforme/creer-utilisateur/", views.creer_utilisateur_plateforme, name="creer_utilisateur_plateforme"),
    ...
    path("recu/<int:pk>/pdf/", views.recu_paiement_pdf, name="recu_paiement_pdf"),
